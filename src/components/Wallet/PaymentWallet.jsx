    ...
    <div className="w-screen h-screen signup-outer-wrapper relative overflow-x-hidden mt-12 mb-12">
      ...
      >
       ...
       <div >
        ...
        <div className="bg-[#9098A1] h-10 w-10 rounded-full flex items-center justify-center " onClick={()=>{setWallet(!wallet)}}>
            +
        </div>
        </div>
       </div>
...
const useStyles = makeStyles((theme) => ({
    title: {
      ...
      signupTabs :{
        ...
        cursor: "pointer",
        marginBottom: "20px",
        background: "linear-gradient(0deg, var(--primary), var(--primary)), #FFFFFF",
