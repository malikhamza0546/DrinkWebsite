...
const Cart = ({ ID, productName, productDescription, EstablishmentID, price }) => {
	...
	// console.log("ID in EstablishmentIDEstablishmentID", ProductsOrderReducer, ProductCartOrder)
	...
	const handleClick = () => {
		const innerProd = {}
		innerProd["productName"] = productName
		innerProd["count"] = quantity
		innerProd["price"] = price * quantity
		...
		console.log("Nafeel-----", addons, quantity, ID, productName, productDescription, EstablishmentID)
